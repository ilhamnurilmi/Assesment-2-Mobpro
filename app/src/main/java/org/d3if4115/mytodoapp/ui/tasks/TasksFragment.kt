...
import org.d3if4115.mytodoapp.util.exhaustive
import org.d3if4115.mytodoapp.util.onQueryTextChanged
            ...
            viewModel.tasksEvent.collect { event ->
                when (event) {
                    is TasksViewModel.TasksEvent.ShowUndoDeleteTaskMessage -> {
                        Snackbar.make(requireView(), "ToDo Terhapus", Snackbar.LENGTH_LONG)
                            .setAction("UNDO") {
